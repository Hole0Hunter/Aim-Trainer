...
public class TargetBoundsT : MonoBehaviour
{
    public static TargetBoundsT Instance;
    ...
    void Start()
    {
        ...
        for (int i = 0; i < 3; i++)
        {
            ...
            GameObject t = Instantiate(target, pos, Quaternion.identity);

            float zOffset = Random.Range(20f, 24f);
            t.transform.position = new Vector3(pos.x, pos.y, zOffset);
        }
